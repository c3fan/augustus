...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1_TEXT, "石匠们正在铺设一系列精心雕琢的石块，以建造这座墓园的中央拱顶。"},
    ...
    {TR_BUILDING_CONCRETE_MAKER, "水泥厂"},
    ...
    {TR_USER_DIRECTORIES_NOT_SET_UP_TITLE, "没有设置Augustus用户文件夹"},
    {TR_USER_DIRECTORIES_NOT_SET_UP_TEXT, "你还没有设置Augustus用户文件夹（游戏存档、自定义场景和地图会保存在这里）。\n"
                                          "现在进行设置？"},
    {TR_USER_DIRECTORIES_CANCELLED_TITLE, "取消设置用户文件夹"},
    {TR_USER_DIRECTORIES_CANCELLED_TEXT, "由于没有设置Augustus用户文件夹，默认使用C3游戏目录。\n"
                                         "之后可以在游戏设置再进行设置。"},
    ...
    {TR_USER_DIRETORIES_WINDOW_USER_PATH, "Augustus用户文件夹："},
    {TR_USER_DIRECTORIES_USER_PATH_CHANGED_TITLE, "Augustus用户文件夹已变更"},
    {TR_USER_DIRECTORIES_USER_PATH_CHANGED_TEXT, "成功修改Augustus用户文件夹。立即复制所有文件？"},
