...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "维纳斯用光点亮你的城市花园、雕像及神庙，提高地区满意度，使住宅可存放更多物资且退化速度更慢。"},
    ...
    {TR_BUILDING_NYMPHAEUM_DESC, "该大型神庙供奉女神宁芙-泉水、河流、海洋里的小神灵。它能赋予这片土地-美丽和富裕，予以城市神圣的关爱。"},
