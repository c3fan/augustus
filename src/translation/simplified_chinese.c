...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_CERES_BONUS_DESC, "来自塞丽丝的祝福：\n- 农场推车工移动速度+50%"},
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_BONUS_DESC, "来自纳普敦的祝福：\n- 水泉和水井范围+1，贮水池范围+2，供水服务劳工数-50%\n- 商船行驶速度+25%\n- 居民疾病扩撒速度大幅下降"},
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_BONUS_DESC, "陆地商人和海上商船受到莫丘里的祝福：\n- 携货量+50%\n- 陆地商人移动速度+25%"},
    {TR_BUILDING_GRAND_TEMPLE_MARS_BONUS_DESC, "马尔斯鼓励市民参军入伍，向城市要塞派遣新兵。\n- 可额外建造四座要塞。"},
    ...
    {TR_BUILDING_CERES_TEMPLE_QUOTE, "起初，塞丽丝教会了勤劳的人们如何种地\n养育大地，播种生机\n她向人们提供健康的食物\n也为这罪恶的世界带来了法律\n-\n-奥维德-《变形记》- 第五卷"},
    ...
    {TR_BUILDING_GRAND_TEMPLE_PHASE_1_TEXT, "工人们正在建造神庙的基台，打牢坚实的地基，以经得起时间的风吹雨打。"},
    ...
    {TR_BUILDING_SMALL_MAUSOLEUM_DESC, "这座墓园是城市贵族为已故先人打造的安息之地，也是许多活着的人向往之地。"},
